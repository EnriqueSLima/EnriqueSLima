...
if len(numerico_cpf) == 11:         #   Verifica se o CPF sem a pontuação possui 11 caracteres  
    ...
    for i in range(9):                                                  #   Iteração até o elemento 9
        multiplicador_etapa1 = int(numerico_cpf[i]) * (int(i)+1)        #   Transforma o valor 'i' em inteiro e multiplica por ele mesmo
    ...
    resto_etapa1 = somador_etapa1 % 11                          #   Dividindo o valor de 'somador_etapa1' por 11 e atribuindo ao resto
    print('Resto da primeira divisão: ', resto_etapa1)          #   Imprime o valor da 'resto_etapa1' (OPCIONAL)
    if resto_etapa1 >= 10:
        resto_etapa1 = resto_etapa1%10
        print('Caso >= 10: ', resto_etapa1)
    else:
        resto_etapa1 = resto_etapa1

    if resto_etapa1 == int(numerico_cpf[-2]):                   #   Verificando o digito verificador
        ...
        resto_etapa2= somador_etapa2 % 11                           #   Dividindo o valor de 'somando' por 11 e atribuindo ao resto
        print('Resto da segunda divisão: ', resto_etapa2)           #   Imprime o valor da 'resto_etapa1' (OPCIONAL)
        if resto_etapa2 >= 10:
            resto_etapa2 = resto_etapa2%10

        if resto_etapa2 == int(numerico_cpf[-1]):                   #   Verificando o digito verificador
            print('CPF válido.')
else:
    print('CPF inválido.')
